...
/// # Parameters
///
/// - `fee`: The fee rate as a basis point value (i.e., hundredths of a percent, with 10,000 basis
/// points equaling 100%).
...
/// - It then subtracts the calculated fee amount from the original loan amount to determine the
/// final loan amount.
